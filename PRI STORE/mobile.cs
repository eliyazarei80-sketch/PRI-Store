...
namespace PRI_STORE
{
    public partial class mobile : Form
    {
        ...
        private void pictureBox6_Click(object sender, EventArgs e)
        {
            ...
            this.Hide(); // این فرم (موبایل ) رو مخفی میکنه
        }
        ...
        {
            panel2.BackColor = Color.Gold; //وقتی موس روی تصویر میاد، رنگ پنل 2 به طلایی تغییر میکنه
        }
        ...
        {
            panel3.BackColor = Color.Silver; //وقتی موس روی تصویر میاد، رنگ پنل 3 به نقره ای تغییر میکنه
        }
        ...
        {
            panel4.BackColor = Color.Lime; //وقتی موس روی تصویر میاد، رنگ پنل 4 به سبز لایم تغییر میکنه
        }
        ...
        {
            panel7.BackColor = Color.Plum; //وقتی موس روی تصویر میاد، رنگ پنل 7 به آلویی تغییر میکنه
        }
        ...
        {
            panel8.BackColor = Color.Blue; //وقتی موس روی تصویر میاد، رنگ پنل 8 به آبی  تغییر میکنه
        }
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            ...
            i.Show(); // فرم آیفون رو نمایش میده
        }

        private void pictureBox2_Click(object sender, EventArgs e)
        {
            siyomi s = new siyomi(); // یه نمونه از فرم شیامی میسازه
            s.Show(); // فرم شیامی رو نمایش میده
        }

        private void pictureBox3_Click(object sender, EventArgs e)
        {
            sumsung s = new sumsung(); // یه نمونه از فرم سامسونگ میسازه
            s.Show(); // فرم سامسونگ رو نمایش میده
        }

        private void pictureBox4_Click(object sender, EventArgs e)
        {
            nokia n = new nokia(); // یه نمونه از فرم نوکیا میسازه
            n.Show(); // فرم نوکیا رو نمایش میده
        }
