...
namespace PRI_STORE
{
    public partial class varzeshi : Form
    {
        public varzeshi()
        {
        ...
        private void pictureBox6_Click(object sender, EventArgs e)
        {
            ...
            this.Hide(); //این فرم (ورزشی )رو مخفی میکنه
        }
        ...
        {
            panel1.BackColor = Color.MediumBlue; //وقتی موس روی تصویر میاد، رنگ پنل 1 به آبی متوسط تغییر میکنه
        }
        ...
        {
            panel2.BackColor = Color.Lime; //وقتی موس روی تصویر میاد، رنگ پنل 2 به سبز لایم متوسط تغییر میکنه
        }
        ...
        {
            panel3.BackColor = Color.Khaki; //وقتی موس روی تصویر میاد، رنگ پنل 3 به خاکی تغییر میکنه
        }
        ...
        {
            panel7.BackColor = Color.OrangeRed; //وقتی موس روی تصویر میاد، رنگ پنل 7 به نارنجی تیره تغییر میکنه
        }
        ...
        {
            panel8.BackColor = Color.MediumPurple; //وقتی موس روی تصویر میاد، رنگ پنل 8 به بنفش متوسط تغییر میکنه
        }
        ...
        {
            setmardane  s = new setmardane (); // یه نمونه از فرم setmardane میسازه
            s.Show(); // فرم setmardane رو نمایش میده
        }

        private void pictureBox2_Click(object sender, EventArgs e)
        {
            kafsh k = new kafsh(); // یه نمونه از فرم kafsh میسازه
            k.Show(); // فرم kafsh رو نمایش میده
        }

        private void pictureBox3_Click(object sender, EventArgs e)
        {
            toop t = new toop(); // یه نمونه از فرم toop میسازه
            t.Show(); // فرم toop رو نمایش میده
        }

        private void pictureBox4_Click(object sender, EventArgs e)
        {
            setzanane s = new setzanane(); // یه نمونه از فرم setzanane میسازه
            s.Show(); // فرم setzanane رو نمایش میده
        }
