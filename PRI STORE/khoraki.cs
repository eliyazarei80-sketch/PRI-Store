...
namespace PRI_STORE
{
    public partial class khoraki : Form
    {
        public khoraki()
        {
        ...
        private void pictureBox6_Click(object sender, EventArgs e)
        {
            ...
            this.Hide(); // این فرم (خوراکی ) رو مخفی میکنه
        }
        ...
        {
            panel1.BackColor = Color.DarkSlateBlue; //وقتی موس روی تصویر میاد، رنگ پنل 1 به آبی تیره کدر تغییر میکنه
        }
        ...
        {
            panel2.BackColor = Color.DarkViolet; //وقتی موس روی تصویر میاد، رنگ پنل 2 به بنفش تیره تغییر میکنه
        }
        ...
        {
            panel3.BackColor = Color.Pink; //وقتی موس روی تصویر میاد، رنگ پنل 3 به صورتی تغییر میکنه
        }
        ...
        {
            panel4.BackColor = Color.Orange; //وقتی موس روی تصویر میاد، رنگ پنل 4 به نارنجی تغییر میکنه
        }
        ...
        {
            panel7.BackColor = Color.Brown; //وقتی موس روی تصویر میاد، رنگ پنل 7 به قهوه ای تغییر میکنه
        }
        ...
        {
            panel8.BackColor = Color.DarkOrange; //وقتی موس روی تصویر میاد، رنگ پنل 8 به نارنجی تیره تغییر میکنه
        }
        ...
        {
            rob r = new rob(); // یه نمونه از فرم رب میسازه
            r.Show(); // فرم رب رو نمایش میده
        }

        private void pictureBox2_Click(object sender, EventArgs e)
        {
            pizza p = new pizza(); // یه نمونه از فرم پیتزا میسازه
            p.Show(); // فرم پیتزا رو نمایش میده
        }

        private void pictureBox3_Click(object sender, EventArgs e)
        {
            noshabe n = new noshabe(); // یه نمونه از نوشابه شرت میسازه
            n.Show(); // فرم نوشابه رو نمایش میده
        }

        private void pictureBox4_Click(object sender, EventArgs e)
        {
            bereng b = new bereng(); // یه نمونه از فرم برنج میسازه
            b.Show(); // فرم برنج رو نمایش میده
        }
